    ...
    <body>
        ...
        <?php
            ...
            ?>
                ...
                <h5><?php echo $quiz;?></h5>
                <input type="radio" name="options' + <?php echo $i; ?>'" value="A"><?php echo $optionA;?><br>
                <input type="radio" name="options' + <?php echo $i; ?>'" value="B"><?php echo $optionB;?><br>
                <input type="radio" name="options' + <?php echo $i; ?>'" value="C"><?php echo $optionC;?><br>
                <input type="radio" name="options' + <?php echo $i; ?>'" value="D"><?php echo $optionD;?><br>
                </div>
                <?php
            }
            ?>

            <input type="submit" name="submitQuiz" value="Submit" id="submitBtn">
            </form>
            </div>
